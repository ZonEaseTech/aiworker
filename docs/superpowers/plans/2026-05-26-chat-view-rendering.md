...
Create `docs/plan/PLAN-419.md` with this content:

```markdown
# PLAN-419 Generic chat view rendering primitives
...
```markdown
- [-] [**PLAN-419 Generic chat view rendering primitives**](PLAN-419.md) `2026-05-26`
```
...
```bash
git add docs/task/TODO-048.md docs/task/index.md docs/plan/PLAN-419.md docs/plan/index.md
...
Update the metadata block in `docs/plan/PLAN-419.md` to:
...
Append this section to `docs/plan/PLAN-419.md`:
...
Change the `PLAN-419` line in `docs/plan/index.md` to:
