...
- 2026-04-30 08:39 完成发布。GitHub Actions run `25155810117` 成功，npm latest 是
  `0.4.8`，已发布 CLI smoke 返回 `aiworker/0.4.8`，GitHub Release `v0.4.8`
  包含四个平台 tarball。
- 2026-04-30 08:39 Release workflow 有 GitHub Actions Node.js 20 deprecation annotation，
...
- Passed: GitHub Actions release workflow `25155810117` for `v0.4.8`
- Passed: npm registry verification resolved `@zonease/aiworker-cli@0.4.8` as
  `latest`
- Passed: published-package smoke reported `aiworker/0.4.8`
- Passed: GitHub Release `v0.4.8` has linux-x64, linux-arm64, darwin-x64, and
