...
- 2026-05-06 09:51：本地 release gates 全通过；`apps/cli/dist/package.json`
  版本字段 `0.9.2`；built CLI `--version` 返回
  `aiworker/0.9.2 linux-x64 node-v24.3.0`。
- 2026-05-06 09:54：发布完成。Release commit `4b5697c` + annotated tag
  `v0.9.2` 已 push；GitHub Actions release workflow `25428320371` 全绿；
  npm `latest=0.9.2`；GitHub Release `v0.9.2` 非 draft / 非 prerelease；
  4 平台 binary 全 uploaded。`bunx @zonease/aiworker-cli@0.9.2 --version`
  返回 `aiworker/0.9.2 linux-x64 node-v24.3.0`。
