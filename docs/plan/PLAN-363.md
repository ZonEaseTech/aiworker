...
- [x] `gh run watch 26045311566 --repo ZonEaseTech/aiworker --exit-status`
- [x] `npm view @zonease/aiworker-cli version dist-tags --json`
- [x] `bunx @zonease/aiworker-cli@0.17.6 --version`
- [x] `gh release view v0.17.6 --repo ZonEaseTech/aiworker --json tagName,isDraft,isPrerelease,assets,url,publishedAt,targetCommitish`
...
- 2026-05-18：release prep commit `2e8c16b9`、tag `v0.17.6` 已推送；
  release workflow `26045311566` 与 main lint workflow `26045309534` 均成功。
- 2026-05-18：post-release verification 通过；npm latest 为 `0.17.6`，
  GitHub Release `v0.17.6` 为 non-draft / non-prerelease 且包含 8 个
