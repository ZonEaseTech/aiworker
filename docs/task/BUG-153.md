...
Mounted micro-apps can emit an opaque `locator:workspace-selected` event. Host
Web validates it against the current worker and refreshed workspace list before
updating route state and mounted host data.
