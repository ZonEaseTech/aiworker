...
function parseSkillMetadata(raw: string, filePath: string): Omit<OpenClawSkill, 'hash'> | null {
...
export async function scanOpenClawSkills(openclawHome?: string): Promise<OpenClawSkill[]> {
