...
export const ja = {
  accessibility: {
    ...
    soulProjectsAndArtifacts: 'ワークスペースとセッション',
    viewMode: '表示モード',
    workspace: 'ワークスペース',
  },
  app: {
    ...
    subtitle: 'ワークスペースとセッション',
    workspacePill: 'ワークベンチ',
  },
  artifact: {
  ...
  create: {
    ...
    footer: 'セッションは既定でこのワークスペース内に保持されます。',
  ...
  workspace: {
    ...
    byokReady: (provider, model) => `${provider} ${model} でメッセージを送信できます。`,
    composerReadyAction: '設定を開く',
    copyAsMarkdown: 'Markdown としてコピー',
    enginePosture: 'AI エンジンは高い権限で動作します。このワークスペースのファイルを読み書きでき、ネットワークにアクセスする場合があります。',
    retryMessage: '再試行',
    archive: 'アーカイブ',
    ...
    engineReadyDetail: engineName => `${engineName} でメッセージを送信できます。`,
    engineRole: 'AIWorker エンジン',
    engineStarting: '応答を生成しています...',
    eventCount: count => `イベント ${count} 件`,
    eventStream: 'セッションイベント',
    followUpInput: '会話を続ける',
    ...
    noInvocations: 'このセッションにはまだメッセージがありません。',
    sendInvocation: '送信',
    ...
    invocationCount: count => `メッセージ ${count} 件`,
    invocationHistory: 'メッセージ履歴',
  ...
  chat: {
    preparingResponse: '応答を準備中',
    startingInvocation: '開始しています',
    waitingForEngine: 'エンジンの応答を待っています。',
    timeline: {
      invocationStarted: '開始しました',
      working: '処理中',
      invocationWarning: '警告',
      engineWarning: 'エンジンの警告',
      invocationCompleted: '完了しました',
      invocationCancelled: 'キャンセルしました',
      invocationFailed: '失敗しました',
      processStarted: 'プロセスを開始しました',
      processExited: 'プロセスが終了しました',
      processLost: 'プロセスが失われました',
      engineError: 'エンジンエラー',
    },
  },
  relativeTime: {
  ...
  settings: {
    ...
    dialog: {
      ...
      subtitle: 'このワークスペースのセッション実行、ローカルアダプター、Soul、言語、外観を設定します。',
      title: 'ローカル設定',
    },
    engine: {
    ...
    localMcp: {
      hint: 'workspace MCP binding 待ちです。この設定はまだサーバーを起動しません。',
  ...
  workerConfig: {
    ...
    unsavedChangesDescription: 'インラインの内容編集はまだ保存されていません。切り替える前に破棄しますか？',
