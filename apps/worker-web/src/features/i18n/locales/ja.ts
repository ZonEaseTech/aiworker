...
export const ja = {
  ...
  workspace: {
    ...
    firstRunRailHint: 'メインワークスペースで有効な Soul App を選択してください。',
    firstRunRailTitle: '初回起動',
    firstRunTitle: '開始する Soul App を選択',
    ...
    noMountedSurface: 'マウントされた Soul App 画面はありません',
    noMountedSurfaceDetail: soulName => `${soulName} はこのロケーター向けのマウント済みワークベンチをまだ公開していません。`,
    noSoulApps: '有効な Soul App はありません',
    noSoulAppsDetail: 'Soul App をインストールして有効化するか、worker を手動で作成してください。',
    ...
    startSoulApp: appName => `${appName} を開始`,
  ...
  settings: {
    ...
    soulPacks: {
      ...
      enabledConnector: '有効',
      hint: 'インストール済み Soul Apps は、作成できる worker と workspace の種類を定義します。診断情報は worker レールではなくここに集約します。',
