...
export const de = {
  ...
  workspace: {
    ...
    noMountedSurface: 'Keine gemountete Soul-App-Fläche',
    noMountedSurfaceDetail: soulName => `${soulName} stellt für diesen Locator noch keinen gemounteten Workbench bereit.`,
