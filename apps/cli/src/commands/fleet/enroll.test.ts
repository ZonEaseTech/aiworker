...
/**
 * PLAN-019 / FEAT-026 — `aiworker fleet enroll list/approve/reject` CLI 路由测试。
 *
...
describe('aiworker fleet enroll list', () => {
...
describe('aiworker fleet enroll approve', () => {
...
describe('aiworker fleet enroll reject', () => {
