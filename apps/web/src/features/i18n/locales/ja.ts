...
export const ja = {
  ...
  workspace: {
    ...
    firstRunDetail: '作業に合う Soul App から始めます。AIWorker は先に worker を作成し、その後ワークスペースとレビュー可能な成果物へ進めます。',
    ...
    mountedContributionsPaused: 'マウントされた貢献は一時停止中',
  ...
  settings: {
    ...
    dialog: {
      kicker: 'AIWORKER プラットフォーム',
      subtitle: 'このローカル Host のセッション実行、プラットフォームコネクター、Soul App、言語、外観を設定します。',
      title: 'プラットフォーム設定',
    },
    engine: {
    ...
    soulPacks: {
      ...
      mountedContributionCount: count => `マウント済み貢献 ${count} 件`,
      permissionsTitle: 'Permissions',
      permissionCount: count => `権限 ${count} 件`,
      templateCount: count => `テンプレート ${count} 件`,
      title: 'Soul Apps',
