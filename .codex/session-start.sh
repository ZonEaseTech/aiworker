#!/bin/bash
# Checks for the code-review-graph knowledge graph and outputs Codex-specific guidance.
...
- Fall back to rg/Read only when the graph does not cover what you need.
