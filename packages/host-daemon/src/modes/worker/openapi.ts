...
export function registerLocalOpenApiPaths(app: OpenAPIHono): void {
  ...
  const paths: Array<{
    ...
    { method: 'post', path: '/api/workspace-locators', summary: 'Create workspace locator', tags: ['workspace-locators'], created: true },
    { method: 'get', path: '/api/workspace-locators', summary: 'List workspace locators', tags: ['workspace-locators'] },
    ...
    { method: 'post', path: '/api/sessions', summary: 'Create AIWorker session', tags: ['sessions'], created: true },
    { method: 'get', path: '/api/sessions', summary: 'List AIWorker sessions', tags: ['sessions'] },
    ...
    { method: 'get', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root', tags: ['app-owned-api'] },
    { method: 'post', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root', tags: ['app-owned-api'], created: true },
    { method: 'put', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root', tags: ['app-owned-api'] },
    { method: 'patch', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root', tags: ['app-owned-api'] },
    { method: 'delete', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root', tags: ['app-owned-api'] },
    { method: 'get', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path', tags: ['app-owned-api'] },
    { method: 'post', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path', tags: ['app-owned-api'], created: true },
    { method: 'put', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path', tags: ['app-owned-api'] },
    { method: 'patch', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path', tags: ['app-owned-api'] },
    { method: 'delete', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path', tags: ['app-owned-api'] },
  ]
