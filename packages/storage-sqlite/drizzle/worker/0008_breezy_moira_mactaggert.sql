...
INSERT INTO `__new_engine_invocations`("id", "session_id", "turn_id", "seq", "engine_id", "engine_command", "status", "prompt", "summary", "error", "metadata_json", "started_at", "finished_at", "created_at", "updated_at") SELECT "id", "session_id", "turn_id", "seq", "engine_id", "engine_command", "status", "prompt", "summary", "error", "metadata_json", "started_at", "finished_at", "created_at", "updated_at" FROM `engine_invocations`;--> statement-breakpoint
