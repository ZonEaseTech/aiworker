...
export function registerLocalOpenApiPaths(app: OpenAPIHono): void {
  ...
  const paths: Array<{
    ...
    { method: 'options', path: '/api/apps/{appId}', summary: 'Proxy app-owned API root preflight', tags: ['app-owned-api'] },
    ...
    { method: 'options', path: '/api/apps/{appId}/{path}', summary: 'Proxy app-owned API path preflight', tags: ['app-owned-api'] },
