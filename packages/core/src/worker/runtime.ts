...
export function buildWorkerRuntime(workerId: string, config: WorkerConfig, deps: BuildRuntimeDeps): WorkerRuntime {
  ...
  const orchestrator = new Orchestrator({
    ...
    brain,
    executor,
    ...(controlExecutor.executor === undefined ? {} : { controlExecutor: controlExecutor.executor }),
    ...(controlExecutor.config === undefined ? {} : { controlExecutorConfig: controlExecutor.config }),
